...
namespace Isometric_Board
{
    class GridMap
    {
        public string[] aRow = { "v", "v", "v", "v", "v", "v", "v" };
        public string[] bRow = { "v", "v", "v", "v", "v", "v", "v" };
        public string[] cRow = { "v", "v", "v", "v", "v", "v", "v" };
        public string[] dRow = { "v", "v", "v", "v", "v", "v", "v" };
        public string[] eRow = { "v", "v", "v", "v", "v", "v", "v" };
        public string[] fRow = { "v", "v", "v", "v", "v", "v", "v" };
        public string[] gRow = { "v", "v", "v", "v", "v", "v", "v" };
