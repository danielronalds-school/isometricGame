...
namespace Isometric_Board
{
    class Grid
    {
        ...
        public Grid()
        {
            A1 = new Point(x_offset + 81, y_offset + 84);
            ...
            B1 = new Point(x_offset + 103, y_offset + 95);
            ...
            C1 = new Point(x_offset + 125, y_offset + 106);
            ...
            D1 = new Point(x_offset + 147, y_offset + 117);
            ...
            E1 = new Point(x_offset + 169, y_offset + 128);
            ...
            F1 = new Point(x_offset + 191, y_offset + 139);
